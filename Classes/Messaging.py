...
class Messaging:
    ...
    def sendMessage(messageType, fields, cryptoInit, player=None ,needEncrypt=True):
        ...
        message.messagePayload = cryptoInit.encryptServer(message.getMessageType(), message.messagePayload, needEncrypt)
