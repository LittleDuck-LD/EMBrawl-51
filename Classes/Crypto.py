...
class Crypto:
    ...
    def encryptServer(self, packet_id, payload, needEncrypt=True):
        if packet_id == 20100:
            return payload
        #elif packet_id == 20103 and needEncrypt == False:
        #    return payload
        else:
            if packet_id == 20104 or packet_id == 20103 and needEncrypt == False:
